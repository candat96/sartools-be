...
export class UserService {
  ...
  async createUser(dto: CreateUserRequest): Promise<ApiResponse<CreateUserResponse>> {
    ...
    const data = await this.userRepository.save(this.userRepository.create({
      ...dto,
      salt,
  ...
  async updateUser(id: number, dto: UpdateUserRequest): Promise<ApiResponse<UpdateUserResponse>> {
